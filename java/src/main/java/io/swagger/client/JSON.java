...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(ThingBase.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("PostThingRequest".toUpperCase(), PostThingRequest.class);
                classByDiscriminatorValue.put("Thing".toUpperCase(), Thing.class);
                classByDiscriminatorValue.put("ThingBase".toUpperCase(), ThingBase.class);
