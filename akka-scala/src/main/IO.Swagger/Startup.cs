    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Version = "1.1.0",
                        Title = "Petter's forked version of Filip´s API of Things",
                        Description = "Petter's forked version of Filip´s API of Things (ASP.NET Core 3.0)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/1.1.0/swagger.json", "Petter's forked version of Filip´s API of Things");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "Petter's forked version of Filip´s API of Things Original");
            });
